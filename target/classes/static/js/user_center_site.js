    ...
    function reloadAddressList() {
        if(address_list != null){
            for (var i = 0; i < address_list.length; i ++){
                ...
                var htmlContent = "";
                htmlContent += "<dd>" + addressVO.address + "  （" + addressVO.addresseeName + " 收） "
                    + addressVO.encrptTelphone + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"radio\"  id=\"address_"+ addressVO.id +"\" name=\"address\" value=\"" +addressVO.id + "\"";
